...
symbol_count = 0
mypath = '/etc/openhab2/html/habpanel/svg/original/icon/'
...
for file in onlyfiles:
	if(file[:1] != '.'):
		r = requests.get('http://127.0.0.1:8080/static/habpanel/svg/original/icon/' + file)
		...
		print "";
f = open('/etc/openhab2/html/habpanel/svg/icons.svg', 'w')
